...
<?php if ($divisi_ketua): ?>
    <section class="divisi-leader-section">
        <div class="divisi-leader-container">
            <h2 class="section-title-center">Kepala<span class="highlight"> Divisi</span></h2>
...
<section class="divisi-members-section">
    <div class="divisi-members-container">
        <h2 class="section-title-center">Anggota<span class="highlight"> Divisi</span></h2>
...
<section class="divisi-proker-section">
    <div class="divisi-proker-container">
        <h2 class="section-title-center">Program<span class="highlight"> Kerja</span></h2>

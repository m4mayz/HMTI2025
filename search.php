...
<section class="py-12">
    <div class="container mx-auto px-6 lg:px-24">
        ...
        <div class="flex justify-center w-full mb-12 relative z-50">
            <div
                class="w-full sm:w-[90%] lg:w-[70%] h-14 sm:h-16 border border-black/20 rounded-full flex items-center py-2 px-3 sm:px-4 lg:px-5 bg-white">
                <form method="get" action="<?php echo home_url('/'); ?>" class="flex items-center w-full h-full">
                    <div class="relative flex cursor-pointer">
                        <div
                            class="btn-dropdown-cat flex justify-between items-center w-[60px] sm:w-[80px] lg:w-[100px]">
                            <p
                                class="text-xs sm:text-sm lg:text-base text-dark-bg font-body font-medium selected-dropdown">
                                Cari</p>
                            <svg class="w-3 h-3 sm:w-4 sm:h-4 ml-1 sm:ml-2 shrink-0" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">

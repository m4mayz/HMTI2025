...
<footer class="site-footer">
    <div class="container">
        <div class="footer-main">
            ...
            <div class="footer-widget footer-about">
                <div class="footer-logo">
                    ...
                    <span class="footer-brand-name">HMTI Universitas Nusa Putra</span>
                </div>
                <p class="footer-description">Pusat informasi resmi, arsip kegiatan, dan publikasi Himpunan Mahasiswa
                    Teknik Informatika.</p>
                <div class="footer-social-media">
                    <a href="https://www.instagram.com/hmti_unsp/" target="_blank" aria-label="Instagram">
                    ...
                    <a href="https://www.youtube.com/@hmtiuniversitasnusaputra3200" target="_blank"
                        aria-label="YouTube">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path
                    ...
                    <a href="https://www.tiktok.com/@hmti_unsp?_t=8YEiT9vgFYf&_r=1" target="_blank" aria-label="TikTok">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
            ...
            <div class="footer-widget footer-contact">
                ...
                <div class="contact-item">
                    ...
                    <a href="mailto:hmti@nusaputra.ac.id">hmti@nusaputra.ac.id</a>
                </div>

                <div class="contact-item">
                    <svg width="64px" height="64px" viewBox="0 0 24.00 24.00" fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"
                            stroke="currentColor" stroke-width="0.384"></g>
        ...
        <div class="footer-bottom-bar">
            <p>&copy; <?php echo date('Y'); ?> KOMINFO HMTI Universitas Nusa Putra. Seluruh Hak Cipta.</p>
        </div>
    </div>
</footer>
